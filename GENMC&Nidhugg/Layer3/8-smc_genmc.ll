; ModuleID = 'test2/8-smc_genmc.c'
source_filename = "test2/8-smc_genmc.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%union.pthread_attr_t = type { i64, [48 x i8] }

@smc_mode_enabled = dso_local global i32 0, align 4
@smc_internal_state = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [4 x i8] c"smc\00", align 1
@.str.1 = private unnamed_addr constant [11 x i8] c"state == 1\00", align 1
@.str.2 = private unnamed_addr constant [20 x i8] c"test2/8-smc_genmc.c\00", align 1
@__PRETTY_FUNCTION__.sendmmsg_stub = private unnamed_addr constant [21 x i8] c"void sendmmsg_stub()\00", align 1

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @setsockopt_stub(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i8* %0, i8** %2, align 8
  %5 = load i8*, i8** %2, align 8
  %6 = call i32 @strcmp(i8* %5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0)) #5
  %7 = icmp eq i32 %6, 0
...
8:                                                ; preds = %1
  ...
  store atomic i32 %9, i32* @smc_internal_state monotonic, align 4
  store i32 1, i32* %4, align 4
  %10 = load i32, i32* %4, align 4
  store atomic i32 %10, i32* @smc_mode_enabled monotonic, align 4
  br label %11
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @sendmmsg_stub() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = load atomic i32, i32* @smc_mode_enabled monotonic, align 4
...
7:                                                ; preds = %0
  %8 = load atomic i32, i32* @smc_internal_state monotonic, align 4
...
13:                                               ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i64 0, i64 0), i32 26, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__PRETTY_FUNCTION__.sendmmsg_stub, i64 0, i64 0)) #6
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @thread_ulp(i8* %0) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  call void @setsockopt_stub(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  ret i8* null
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @thread_send(i8* %0) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  call void @sendmmsg_stub()
  ret i8* null
}
...
define dso_local i32 @main() #0 {
  ...
  %4 = call i32 @pthread_create(i64* %2, %union.pthread_attr_t* null, i8* (i8*)* @thread_ulp, i8* null) #7
  %5 = call i32 @pthread_create(i64* %3, %union.pthread_attr_t* null, i8* (i8*)* @thread_send, i8* null) #7
