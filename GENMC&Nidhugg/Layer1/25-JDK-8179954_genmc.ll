; ModuleID = 'test/25-JDK-8179954_genmc.c'
source_filename = "test/25-JDK-8179954_genmc.c"
...
@.str.1 = private unnamed_addr constant [28 x i8] c"test/25-JDK-8179954_genmc.c\00", align 1
...
20:                                               ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([112 x i8], [112 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 32, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5
  unreachable
