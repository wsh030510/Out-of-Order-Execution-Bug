; ModuleID = 'test/barrier_genmc.c'
source_filename = "test/barrier_genmc.c"
...
@.str.1 = private unnamed_addr constant [21 x i8] c"test/barrier_genmc.c\00", align 1
...
define dso_local i8* @reader(i8* %0) #0 {
  ...
  %4 = alloca i32, align 4
  store i8* %0, i8** %2, align 8
  %5 = load atomic i32, i32* @flag monotonic, align 4
...
8:                                                ; preds = %1
  %9 = load atomic i32, i32* @data monotonic, align 4
...
13:                                               ; preds = %8
  call void @__assert_fail(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 18, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__PRETTY_FUNCTION__.reader, i64 0, i64 0)) #4
  unreachable
