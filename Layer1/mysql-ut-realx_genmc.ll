; ModuleID = 'test/mysql-ut-realx_genmc.c'
source_filename = "test/mysql-ut-realx_genmc.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%union.pthread_attr_t = type { i64, [48 x i8] }

@ready = dso_local global i32 0, align 4
@value = dso_local global i32 0, align 4
@start = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.1 = private unnamed_addr constant [28 x i8] c"test/mysql-ut-realx_genmc.c\00", align 1
...
12:                                               ; preds = %6
  ...
  store atomic i32 %13, i32* @value monotonic, align 4
  store i32 1, i32* %5, align 4
  %14 = load i32, i32* %5, align 4
  store atomic i32 %14, i32* @ready monotonic, align 4
  ret i8* null
}
...
define dso_local i8* @reader(i8* %0) #0 {
  ...
  %9 = load atomic i32, i32* @ready monotonic, align 4
  store i32 %9, i32* %5, align 4
  %10 = load i32, i32* %5, align 4
  store i32 %10, i32* %4, align 4
  %11 = load atomic i32, i32* @value monotonic, align 4
...
18:                                               ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 22, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__PRETTY_FUNCTION__.reader, i64 0, i64 0)) #4
  unreachable
